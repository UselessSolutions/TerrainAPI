...
public class StructureFeatures extends GeneratorFeatures{
	public List<Function<Parameters, Boolean>> featureFunctionsList = new ArrayList<>();
	 ...
	 *
	 */
	public void addStructure(Function<Parameters, Boolean> function, Object[] functionParameters){
